...
execute unless score #mode mode_respawns matches 1 if score #map map_id matches 1 as @a[tag=Red,tag=gun_just_died,gamemode=spectator] run tp @s 303.63 38.00 -38.84 -58.03 9.75
execute unless score #mode mode_respawns matches 1 if score #map map_id matches 1 as @a[tag=Blue,tag=gun_just_died,gamemode=spectator] run tp @s 308.43 34.00 156.65 628.82 -0.15
execute unless score #mode mode_respawns matches 1 if score #map map_id matches 2 as @a[tag=Red,tag=gun_just_died,gamemode=spectator] run tp @s 1041.66 39.00 -110.46 129.62 0.90
execute unless score #mode mode_respawns matches 1 if score #map map_id matches 2 as @a[tag=Blue,tag=gun_just_died,gamemode=spectator] run tp @s 879.45 39.00 -274.27 310.52 3.75
execute unless score #mode mode_respawns matches 1 if score #map map_id matches 3 as @a[tag=Red,tag=gun_just_died,gamemode=spectator] run tp @s 110.49 15.00 -320.44 395.46 0.60
execute unless score #mode mode_respawns matches 1 if score #map map_id matches 3 as @a[tag=Blue,tag=gun_just_died,gamemode=spectator] run tp @s -4.60 16.00 -177.36 227.61 -1.39
execute unless score #mode mode_respawns matches 1 as @a[tag=gun_just_died,gamemode=spectator] run tag @s add gun_dead
