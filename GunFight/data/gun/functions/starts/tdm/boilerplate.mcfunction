...
execute in minecraft:overworld run spawnpoint @a[tag=Red,gamemode=!spectator,gamemode=!creative] 1000.00 64.00 1000.00
execute in minecraft:overworld run spawnpoint @a[tag=Blue,gamemode=!spectator,gamemode=!creative] 1020.00 64.00 1020.00
